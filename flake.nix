{
  ...
  inputs = {
    ...
    sdl3 = {
      url = "github:libsdl-org/SDL/5848e584a1b606de26e3dbd1c7e4ecbc34f807a6"; # keep in sync with cmake
      flake = false;
    };
    sdl3_image = {
      url = "github:libsdl-org/SDL_image/19cc7cdb1e30554d3bf4f4526a21a8f57b861279";
      flake = false;
    };
    imgui = {
